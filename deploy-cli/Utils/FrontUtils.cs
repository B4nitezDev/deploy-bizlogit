...
public static class FrontUtil
{
    ...
    private static void ModifyIndexHtmlBizion(string projectPath)
    {
        ...
        // Reemplazar <base href="/"> por <base href="/mobile">
        content = content.Replace("<base href=\"/\" />", "<base href=\"/bizion\" />");
    ...
    private static void ModifyEnviromentBizion(string projectPath)
    {
        ...
        {
            Console.WriteLine($"⚠ No se encontró {enviromentPath}, omitiendo modificación.");
            return;
        }
